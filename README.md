...
[![Build Status](https://travis-ci.com/thomaspoignant/mac-dev-setup.svg?branch=master)](https://travis-ci.com/saidbouig/mac-dev-setup)
...
# Launch installation
```shell
curl https://raw.githubusercontent.com/saidbouig/mac-dev-setup/master/src/mac-dev-setup.sh | bash
```
